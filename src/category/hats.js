...
const Hats = () => {
    ...
    const filteredData = shopData ? shopData.filter((map) => map.title === "Hats") : [];
    return (
        <div className="Navbelow">
            <h2 className="category-heading">Hat's Collection</h2>
            <div className="sort-controls">
                <label className="sort-label" htmlFor="hats-sort">
                    Sort by price:
                </label>
                <select
                    id="hats-sort"
